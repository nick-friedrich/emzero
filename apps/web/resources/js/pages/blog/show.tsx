    ...
    return (
        <>
            ...
            <main className="mx-auto w-full max-w-4xl px-5 py-16 sm:px-8 lg:py-24">
                <Link
                    href={index()}
                    className="mb-12 inline-flex items-center gap-2 text-sm font-bold text-stone-500 hover:text-stone-950"
                >
                    <ArrowLeft className="size-4" />
                    Back to the journal
                </Link>
                <article>
                    <header className="flex flex-col gap-6 border-b border-stone-950/10 pb-12">
                    ...
                    <div className="py-12 text-lg leading-9 whitespace-pre-wrap text-stone-700">
                        {post.body}
                    </div>
                </article>
            </main>
